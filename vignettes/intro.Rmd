...
# h_normalize <- hnode(f_normalize, h_load_data)
# h_dist      <- hnode(f_dist,      h_normalize)
# h_hclust    <- hnode(f_hclust,    h_dist)
```
...
# }
#
# h_val(h$normalize) <- v_iris
# h_val(h$dist)      <- v_normed_df
# h_val(h$hclust)    <- v_dist
# h$hclust()
```
Now lets add output summary functions to each

```{r}
# h_effect(h$load_data) <- print
# h_effect(h$normalize) <- print
# h_effect(h$dist)      <- print
# h_effect(h$hclust)    <- summary
# h$hclust()
```
...
# h_hclust    <- hnode(f_hclust,    h_dist)
#
# h_effect(h_load_data) <- compose(summary, print)
# h_effect(h_normalize) <- compose(summary, print)
# h_effect(h_dist)      <- compose(summary, print)
# h_effect(h_hclust)    <- compose(summary, print)
#
# h_hclust()
#
```
...
# }
#
# h$load_data <- hnode(f_load_data)
#
# h$normalize <- hnode(
#   f_normalize,
#   inode  = list(h$load_data),
#   val    = v_iris,

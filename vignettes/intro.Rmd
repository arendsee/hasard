...
`hasard` is designed to cleanly separate the elements of a workflow.
...
`hasard`'s real power is in highly-branched workflows with complex data and
...
`hasard`'s solution is to partition each function in the pipeline into the
